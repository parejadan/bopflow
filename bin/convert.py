...
if __name__ == '__main__':
    ...
    parser.add_argument("-num_classes", dest="image",
    ...
    parser.add_argument("--output", dest="output",
                        help="filepath for converted weights output")
    args = parser.parse_args()

    args.output = args.output if args.output else "./checkpoints/yolov3.tf"
    args.weights_path = args.weights_path if args.weights_path else "./data/darknet.weights"
